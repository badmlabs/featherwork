...
import {
  FREE_SAVED_DRILL_LIMIT,
  useVaultAccess,
  VAULT_PLANS,
  VaultPlan,
} from '../hooks/useVaultAccess';
              ...
              <>
                <View style={styles.actions}>
                  <TouchableOpacity
                    ...
                    onPress={() => {
                      if (!isSubscribed && stepSets.length >= FREE_SAVED_DRILL_LIMIT) {
                        setPaywallVisible(true);
                        return;
                      }
                ...
                <Text style={styles.listLabel}>
                  Saved drills
                  {!isSubscribed &&
                    ` · ${Math.min(stepSets.length, FREE_SAVED_DRILL_LIMIT)}/${FREE_SAVED_DRILL_LIMIT} free`}
                </Text>
          ...
          <View style={styles.dialogOverlay}>
            <View style={styles.dialogCard}>
              ...
              {[
                ...
                `Unlimited saved drills (free keeps ${FREE_SAVED_DRILL_LIMIT})`,
              ].map((line) => (
